<footer class="et-footer bg-etBlack relative z-[1] before:absolute before:-z-[1] before:inset-0 before:bg-[url('../assets/img/footer-1-bg.jpg')] before:opacity-50 before:mix-blend-overlay text-white">
    <div class="container mx-auto max-w-[calc(100%-37.1vw)] xxxl:max-w-[calc(100%-350px)] xl:max-w-[calc(100%-170px)] px-[12px] lg:max-w-full">
        ...
        <div class="et-footer-top pt-[130px] xl:pt-[80px] pb-[60px]">
            <!-- contact infos -->
            <div class="bg-etBlue py-[35px] px-[40px] xl:px-[30px] rounded-[20px] mb-[60px] overflow-hidden relative z-[1] flex lg:flex-wrap justify-between lg:justify-center xs:justify-start items-center gap-[20px] before:absolute before:-z-[1] before:inset-0 before:bg-[url('../assets/img/et-counter-bg.jpg')] before:bg-cover before:bg-no-repeat before:bg-center before:opacity-40 before:mix-blend-multiply">
                <!-- single info -->
                <div class="flex xxs:flex-col items-center xxs:items-start gap-[15px] xxs:gap-[10px]">
                    ...
                    <div>
                        ...
                        <h5 class="font-medium text-[20px]">Lagos State University, Ojo.</h5>
                    </div>
                </div>
                ...
                <div class="flex xxs:flex-col items-center xxs:items-start gap-[15px] xxs:gap-[10px]">
                    ...
                    <div>
                        ...
                        <h5 class="font-medium text-[20px]"><a href="mailto:info@genderandblueeconomy.org">info@genderandblueeconomy.org</a></h5>
                    </div>
                </div>
                ...
                <div class="flex xxs:flex-col items-center xxs:items-start gap-[15px] xxs:gap-[10px]">
                    ...
                    <div>
                        ...
                        <h5 class="font-medium text-[20px]"><a href="tel:+2348165453832">+234 816 545 3832</a></h5>
                    </div>
                </div>
            </div>
            ...
            <div class="flex md:flex-wrap xs:w-full gap-x-[65px] xxl:gap-x-[45px] xl:gap-[30px] gap-y-[25px] justify-between md:justify-center xxs:justify-start">
                <!-- footer about -->
                <div class="et-footer-about max-w-[400px] lg:max-w-none md:max-w-[300px] xs:max-w-full">
                    <a href="#" class="mb-[25px] inline-block"><img src="assets/img/gg.png" alt="logo"></a>
                    <p class="font-light text-[#f2f2f2] text-[16px] mb-[25px]" style="text-align:justify">
                        The conference’s main goal yearly is to explore the requirements of Nigeria’s blue 
                        economy and identify sustainable technologies and resources to alleviate women’s 
                        poverty while promoting secure growth.
                    </p>
                    ...
                    <div class="et-socials flex gap-[10px] text-[14px] *:border *:border-[#9EAACB] *:text-[#9EAACB] *:w-[40px] *:aspect-square *:shrink-0 *:inline-flex *:items-center *:justify-center *:rounded-full ">
                        <a href="https://web.facebook.com/CGEAfrica?_rdc=1&_rdr" class="hover:text-white hover:bg-etBlue hover:border-etBlue"><i class="fa-brands fa-facebook-f"></i></a>
                        <a href="https://www.linkedin.com/company/centerforgendereconomicsinafricacgeafrica" class="hover:text-white hover:bg-etBlue hover:border-etBlue"><i class="fa-brands fa-twitter"></i></a>
                        <a href="https://x.com/cge_africa" class="hover:text-white hover:bg-etBlue hover:border-etBlue"><i class="fa-brands fa-linkedin-in"></i></a>
                        <a href="https://www.instagram.com/cge_africa/" class="hover:text-white hover:bg-etBlue hover:border-etBlue"><i class="fa-brands fa-instagram"></i></a>
                    </div>
                </div>
                ...
                <div class="et-footer-widget shrink-0 xs:grow">
                    ...
                    <ul class="space-y-[17px] text-[16px] font-light text-[#f2f2f2]">
                        <li>
                            <a href="login.php" class="flex items-center gap-[10px] hover:text-etBlue group">
                                <span class="icon">
                                    <svg width="12" height="16" viewBox="0 0 12 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <li>
                            <a href="register.php" class="flex items-center gap-[10px] hover:text-etBlue group">
                                <span class="icon">
                                    <svg width="12" height="16" viewBox="0 0 12 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M0 15.875V2.28125C0 1.51953 0.615234 0.875 1.40625 0.875H9.84375C10.6055 0.875 11.25 1.51953 11.25 2.28125V15.875L5.625 12.5938L0 15.875Z" class="fill-transparent stroke-white group-hover:stroke-etBlue group-hover:fill-etBlue transition" />
                                    </svg>
                        ...
                        <li>
                            <a href="about.php" class="flex items-center gap-[10px] hover:text-etBlue group">
                                <span class="icon">
                                    <svg width="12" height="16" viewBox="0 0 12 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M0 15.875V2.28125C0 1.51953 0.615234 0.875 1.40625 0.875H9.84375C10.6055 0.875 11.25 1.51953 11.25 2.28125V15.875L5.625 12.5938L0 15.875Z" class="fill-transparent stroke-white group-hover:stroke-etBlue group-hover:fill-etBlue transition" />
                                    </svg>
                                </span>
                                <span class="txt">About <?php echo $appName;?></span>
                            </a>
                        </li>
                        <li>
                            <a href="contact.php" class="flex items-center gap-[10px] hover:text-etBlue group">
                                <span class="icon">
                                    <svg width="12" height="16" viewBox="0 0 12 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M0 15.875V2.28125C0 1.51953 0.615234 0.875 1.40625 0.875H9.84375C10.6055 0.875 11.25 1.51953 11.25 2.28125V15.875L5.625 12.5938L0 15.875Z" class="fill-transparent stroke-white group-hover:stroke-etBlue group-hover:fill-etBlue transition" />
                                    </svg>
                        ...
                        <div class="flex items-center gap-x-[30px] xxs:gap-x-[15px]">
                            ...
                            <div>
                                <span class="date text-[16px] text-etGray flex items-center gap-[12px] mb-[8px]">
                                    ...
                                    <span style="color:white">19-21 NOV 2025</span>
                                </span>

                                <h6 class="font-medium text-[20px] text-white"><a href="news-details.html" class="hover:text-etBlue">G&BE CONFERENCE</a></h6>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="et-footer-bottom border-t border-white/20 py-[34px]">
            <p class="font-light text-[#f2f2f2] text-center text-[16px]">&copy; 2024 - <?php echo $currentYear;?>, <?php echo $appName;?> All Rights Reserved. Developed By <a href="<?php echo $appDeveloperUrl;?>" style="font-weight:1000; text-decoration:none; background: rgb(18 96 254); padding:3px; border-radius: 3px; color:white"><?php echo $appDeveloper;?></a></p>
        </div>
    </div>
</footer>