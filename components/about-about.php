    ...
    <div class="container mx-auto max-w-[calc(100%-39.1vw)] xxxl:max-w-[calc(100%-350px)] xl:max-w-[calc(100%-170px)] px-[12px] lg:max-w-full">
        <div class="flex items-center md:flex-wrap gap-x-[60px] xxl:gap-x-[40px] lg:gap-x-[30px] gap-y-[40px] sm:gap-y-[40px] lg:justify-center">
            ...
            <div class="et-about__txt">
                <h6 class="et-section-sub-title anim-text">About <?php echo $appName;?></h6>
                <h2 class="et-section-title mb-[24px] md:mb-[19px] anim-text">Know More About <?php echo $appName;?> </h2>
                ...
                <p class="mb-[30px] text-[16px] font-light text-etGray md:mb-[30px] rev-slide-up" style="text-align: justify;">
                   We inspire divers leaders in Africa to attain gender equality in economic policies and practices.
                    ...
                    <br><br>
                    Our Overall Goal is to strengthen institutional support, promote women’s access and control to economic activities, and provide general economic well-being for women across all ages..
                </p>
